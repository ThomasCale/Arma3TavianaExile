...
MaxSpawnDistance             = 150;              // Max distance a zombie should spawn from a player.
...
ZombieMoney                  = 50;                // Money per zombie kill
ZombieMaxMoney               = 150;               // Max Money per zombie kill-random amount put on corpses
...
ZombieRespect                = 50;               // Respect per zombie kill
...
_ryanzombieslimit                      = 50;    // Player detection distance in meters
...
HordeSet = [
/* 0 Groups Size  */         50,                 // maximum number of zombies around a player
...
/* 4  Spawn Delay */         30,                 // The delay between each zombie spawn right after the activation until the Max group size is reached.
...
Trigger_6 = [				 //Mission Nuke
/* 0  Use this trigger */    False,               
/* 1  Trigger Positions */   Nuke,            
/* 2  Max Zombies */         5,                 
/* 3  Activation Delay */    30,                  
/* 4  Spawn Delay */         30,                  
/* 5  Respawn Delay */       60,                  
