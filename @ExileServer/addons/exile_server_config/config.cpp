...
class CfgExileEscapeLootServer
{
	class LootTables
	{
		...
		/*
			...
			Trash             = 15,96%
		*/
		CivillianLowerClass[] = {"Food", "CivilianHeadgear", "PistolAmmo", "CivilianBackpacks", "Shotguns", "SMGAttachments", "CivilianVests", "Pistols", "SMGAmmo", "CivilianHeadgear", "Drinks", "Pistols", "Chemlights", "PistolAmmo", "CivilianClothing", "Trash", "Food", "Pistols", "CivilianHeadgear", "CivilianHeadgear", "CivilianItems", "PistolAttachments", "Drinks", "CivilianHeadgear", "Trash", "Pistols", "CivilianItems", "CivilianHeadgear", "Food", "Food", "Trash", "Trash", "CivilianClothing", "Trash", "Trash", "PistolAttachments", "Food", "CivilianClothing", "Trash", "Pistols", "Food", "CivilianBackpacks", "Food", "Food", "Trash", "Chemlights", "Food", "CivilianClothing", "CivilianHeadgear", "Trash", "Trash", "Chemlights", "CivilianClothing", "Drinks", "CivilianClothing", "CivilianBackpacks", "Trash", "CivilianItems", "CivilianItems", "CivilianItems", "CivilianHeadgear", "Shotguns", "Trash", "Drinks", "RoadFlares", "CivilianHeadgear", "Drinks", "RoadFlares", "Trash", "CivilianVests", "Food", "CivilianHeadgear", "SMG", "CivilianClothing", "CivilianBackpacks", "Chemlights", "RoadFlares", "CivilianItems", "Drinks", "Food", "CivilianBackpacks", "Food", "SMGAttachments", "CivilianClothing", "CivilianClothing", "SMG", "CivilianHeadgear", "PistolAmmo", "SMGAttachments", "Food", "Pistols", "CivilianHeadgear", "Trash", "Trash", "CivilianClothing", "CivilianVests", "Drinks", "Trash", "RoadFlares", "CivilianClothing", "RoadFlares", "Food", "Trash", "PistolAttachments", "Chemlights", "CivilianHeadgear", "Shotguns", "Pistols", "CivilianHeadgear", "Chemlights", "Food", "CivilianVests", "Drinks", "SMGAmmo", "Food", "Food", "CivilianHeadgear", "CivilianBackpacks", "CivilianHeadgear", "CivilianItems", "Food", "CivilianClothing", "CivilianClothing", "CivilianVests", "Chemlights", "Chemlights", "Food", "CivilianItems", "Food", "PistolAmmo", "ShotgunAmmo", "Food", "Food", "CivilianItems", "Restraints", "CivilianClothing", "CivilianBackpacks", "CivilianBackpacks", "CivilianBackpacks", "CivilianBackpacks", "Trash", "CivilianHeadgear", "Shotguns", "Food", "SMG", "CivilianHeadgear", "Trash", "Food", "Pistols", "CivilianItems", "RoadFlares", "Trash", "CivilianClothing", "CivilianClothing", "Drinks", "CivilianHeadgear", "Trash", "RoadFlares", "CivilianClothing", "SMGAmmo", "Trash", "Food", "Trash", "Food", "Drinks", "Food", "Trash", "Trash", "Trash", "Trash", "ShotgunAmmo", "Trash", "RoadFlares", "CivilianClothing", "SMG", "Chemlights", "CivilianClothing", "CivilianBackpacks", "CivilianHeadgear", "Trash", "RoadFlares", "Food", "Chemlights", "ShotgunAmmo", "PistolAmmo", "RoadFlares", "CivilianClothing", "Trash"};
		...
		/*
			...
			Trash             = 15,23%
		*/
		CivillianUpperClass[] = {"CivilianHeadgear", "Trash", "Restraints", "CivilianHeadgear", "CivilianBackpacks", "PistolAttachments", "CivilianBackpacks", "CivilianVests", "Drinks", "RoadFlares", "RoadFlares", "CivilianClothing", "Food", "RifleAttachments", "Food", "CivilianClothing", "CivilianBackpacks", "SMG", "Shotguns", "Drinks", "Food", "Food", "Chemlights", "CivilianClothing", "Pistols", "PistolAmmo", "Pistols", "CivilianClothing", "Trash", "Food", "CivilianItems", "CivilianItems", "CivilianHeadgear", "SMG", "Food", "Food", "RoadFlares", "Rifles", "RoadFlares", "Chemlights", "Chemlights", "Shotguns", "CivilianHeadgear", "RifleAmmo", "Food", "Trash", "Trash", "CivilianClothing", "PistolAmmo", "RoadFlares", "Drinks", "CivilianBackpacks", "Trash", "SMGAmmo", "RoadFlares", "Trash", "Chemlights", "Drinks", "Pistols", "RoadFlares", "CivilianHeadgear", "Trash", "Trash", "Trash", "SMG", "CivilianItems", "CivilianClothing", "Shotguns", "CivilianItems", "Rifles", "CivilianVests", "RifleAmmo", "Trash", "CivilianHeadgear", "Food", "Food", "Food", "CivilianClothing", "Trash", "CivilianHeadgear", "Food", "Trash", "CivilianClothing", "Drinks", "CivilianClothing", "ShotgunAmmo", "CivilianBackpacks", "Drinks", "SMGAmmo", "CivilianClothing", "CivilianItems", "CivilianHeadgear", "CivilianClothing", "CivilianClothing", "RoadFlares", "Trash", "Drinks", "CivilianClothing", "PistolAmmo", "SMGAttachments", "Food", "Pistols", "Trash", "SMGAttachments", "SMGAmmo", "CivilianClothing", "CivilianVests", "RoadFlares", "Trash", "CivilianItems", "Trash", "Drinks", "CivilianBackpacks", "Food", "PistolAmmo", "Food", "Trash", "CivilianHeadgear", "CivilianClothing", "Food", "Chemlights", "Trash", "CivilianBackpacks", "CivilianClothing", "Pistols", "Drinks", "RifleAttachments", "Trash", "RifleAttachments", "CivilianHeadgear", "CivilianBackpacks", "Food", "CivilianHeadgear", "Chemlights", "Food", "Rifles", "CivilianItems", "Trash", "CivilianClothing", "CivilianHeadgear", "CivilianHeadgear", "Shotguns", "RifleAmmo", "Food", "Trash", "ShotgunAmmo", "CivilianClothing", "CivilianItems", "CivilianItems", "CivilianHeadgear", "Food", "Food", "Pistols", "Trash", "Trash", "Trash", "RoadFlares", "CivilianItems", "Food", "PistolAttachments", "CivilianHeadgear", "Pistols", "Food", "CivilianVests", "CivilianBackpacks", "Food", "CivilianHeadgear", "Trash", "CivilianBackpacks", "CivilianHeadgear", "CivilianHeadgear", "CivilianHeadgear", "Drinks", "Trash", "Trash", "PistolAttachments", "CivilianClothing", "Chemlights", "Chemlights", "Pistols", "CivilianClothing", "Food", "CivilianHeadgear", "Trash", "SMG", "Chemlights", "Food", "Food", "Trash", "Trash", "Food", "CivilianVests", "CivilianBackpacks", "Chemlights", "SMGAttachments", "ShotgunAmmo", "PistolAmmo"};
		...
		/*
			...
			Trash             = 24,00%
		*/
		Shop[] = {"Trash", "SMG", "Trash", "Drinks", "Food", "CivilianVests", "Food", "Restraints", "CivilianBackpacks", "Food", "Trash", "Pistols", "CivilianBackpacks", "Trash", "Drinks", "Trash", "Trash", "Food", "Food", "Trash", "CivilianItems", "Trash", "Pistols", "Pistols", "SMGAmmo", "Pistols", "CivilianHeadgear", "MedicalItems", "RoadFlares", "IndustrialItems", "Trash", "Trash", "Pistols", "Trash", "Food", "Drinks", "Food", "Trash", "ShotgunAmmo", "Pistols", "Drinks", "CivilianItems", "RoadFlares", "Drinks", "Food", "Drinks", "CivilianItems", "Trash", "MedicalItems", "CivilianBackpacks", "CivilianHeadgear", "CivilianItems", "Chemlights", "Trash", "Trash", "Trash", "Trash", "Trash", "Shotguns", "Trash", "Drinks", "SmokeGrenades", "Pistols", "Pistols", "Pistols", "Trash", "Trash", "CivilianBackpacks", "Shotguns", "PistolAmmo", "Trash", "Drinks", "Trash", "Food", "SmokeGrenades", "Trash", "Drinks", "PistolAttachments", "SMG", "Food", "Chemlights", "RoadFlares", "Trash", "RoadFlares", "Chemlights", "Chemlights", "SMG", "CivilianClothing", "Trash", "Shotguns", "Drinks", "Food", "CivilianItems", "Restraints", "CivilianHeadgear", "Trash", "Food", "Food", "Drinks", "RoadFlares", "PistolAmmo", "MedicalItems", "Restraints", "Chemlights", "Shotguns", "CivilianItems", "CivilianBackpacks", "SMGAttachments", "IndustrialItems", "SmokeGrenades", "Trash", "Drinks", "Food", "Trash", "IndustrialItems", "SmokeGrenades", "Drinks", "Trash", "Food", "Drinks", "SMG", "SMG", "Drinks", "Pistols", "CivilianItems"};
		...
		*/
		Industrial[] = {"Trash", "IndustrialItems", "Vehicle", "IndustrialItems", "RoadFlares", "Trash", "IndustrialItems", "IndustrialItems", "Restraints", "Vehicle", "Trash", "RoadFlares", "Vehicle", "IndustrialItems", "Vehicle", "Trash", "RoadFlares", "Trash", "Trash", "IndustrialItems", "Vehicle", "IndustrialItems", "IndustrialItems"};
		...
		*/
		Factories[] = {"IndustrialItems", "Trash", "IndustrialItems", "Electronics", "Trash", "IndustrialItems", "Trash", "Trash", "IndustrialItems", "IndustrialItems"};
		...
		/*
			...
			Vehicle         = 34,78%
		*/
		VehicleService[] = {"Vehicle", "IndustrialItems", "IndustrialItems", "Restraints", "Trash", "Vehicle", "RoadFlares", "Vehicle", "IndustrialItems", "Vehicle", "Vehicle", "Vehicle", "RoadFlares", "RoadFlares", "Trash", "Trash", "Trash", "Trash", "IndustrialItems", "Trash", "IndustrialItems", "Vehicle", "Vehicle"};
		...
		/*
			...
			Trash             = 49,50%
		*/
		Military[] = {"GuerillaHeadgear", "Trash", "GuerillaClothing", "Trash", "MilitaryVests", "CivilianItems", "Trash", "SniperAttachments", "Trash", "GuerillaItems", "Rifles", "Trash", "DLCRifles", "Explosives", "UGLFlares", "Trash", "HandGrenades", "Trash", "Trash", "Trash", "Trash", "RifleAmmo", "Trash", "Trash", "CivilianItems", "Trash", "GuerillaHeadgear", "Trash", "GuerillaClothing", "RifleAmmo", "DLCGhillies", "Trash", "MilitaryClothing", "Trash", "HEGrenades", "Trash", "Trash", "LMGAmmo", "Bipods", "Trash", "GuerillaItems", "Trash", "LMG", "MilitaryClothing", "SniperAmmo", "Trash", "Trash", "Rifles", "DLCOptics", "Trash", "MilitaryBackpacks", "Trash", "DLCSupressor", "Trash", "SmokeGrenades", "Trash", "Snipers", "MedicalItems", "Trash", "Trash", "DLCAmmo", "Trash", "Snipers", "Trash", "GuerillaClothing", "Trash", "Trash", "Trash", "Trash", "Trash", "Rifles", "Trash", "MilitaryBackpacks", "MilitaryClothing", "DLCVests", "Trash", "Trash", "DLCAmmo", "Trash", "Trash", "GuerillaVests", "Trash", "RifleAttachments", "Trash", "Trash", "Explosives", "Trash", "Trash", "Rifles", "Trash", "GuerillaBackpacks", "GuerillaHeadgear", "Restraints", "Trash", "Trash", "Trash", "GuerillaBackpacks", "CivilianItems", "HEGrenades", "Trash", "Trash", "DLCOptics", "UGLSmokes", "Explosives", "Rifles", "GuerillaVests", "DLCVests", "DLCRifles", "SniperAmmo", "Explosives", "MilitaryClothing", "Trash", "UGLFlares", "Trash", "Trash", "Trash", "Trash", "Trash", "Trash", "MilitaryHeadgear", "Trash", "GuerillaBackpacks", "Trash", "Trash", "Trash", "Trash", "Trash", "Trash", "DLCSupressor", "UGLSmokes", "Trash", "MilitaryClothing", "Bipods", "MilitaryVests", "Trash", "Trash", "SmokeGrenades", "LMG", "Trash", "DLCVests", "MilitaryHeadgear", "Ghillies", "Trash", "SniperAttachments", "Snipers", "HandGrenades", "GuerillaItems", "RifleAttachments", "GuerillaBackpacks", "Trash", "Trash", "Trash", "Trash", "Trash", "Explosives", "Trash", "Trash", "Rebreathers", "Trash", "Trash", "LMG", "GuerillaClothing", "HEGrenades", "MilitaryVests", "Trash", "MilitaryHeadgear", "GuerillaVests", "LMGAmmo", "Trash", "Trash", "Trash", "Trash", "Trash", "MedicalItems", "Trash", "GuerillaClothing", "GuerillaItems", "HandGrenades", "Trash", "Trash", "DLCRifles", "Trash", "UGLSmokes", "SmokeGrenades", "Trash", "Trash", "Trash", "MilitaryBackpacks", "Trash", "Trash", "Trash", "RifleAmmo", "Trash", "UGLFlares", "RifleAttachments", "Trash", "Trash", "Trash", "CivilianItems", "LMG", "Restraints", "Trash"};
		...
		/*
			...
			MedicalItems = 70,00%
		*/
		Medical[] = {"Trash", "MedicalItems", "Trash", "MedicalItems", "MedicalItems", "Trash", "MedicalItems", "MedicalItems", "MedicalItems", "MedicalItems"};
		...
		/*
			...
			Snipers           = 17,78%
		*/
		Tourist[] = {"DLCGhillies", "MilitaryHeadgear", "DLCRifles", "Snipers", "Snipers", "MilitaryHeadgear", "DLCRifles", "DLCOptics", "CivilianItems", "MilitaryBackpacks", "DLCRifles", "SniperAttachments", "MilitaryBackpacks", "SniperAmmo", "Ghillies", "Snipers", "MedicalItems", "Restraints", "Snipers", "DLCAmmo", "Ghillies", "Explosives", "Restraints", "DLCSupressor", "DLCRifles", "HandGrenades", "MilitaryHeadgear", "Snipers", "HandGrenades", "Snipers", "CivilianItems", "DLCRifles", "MilitaryHeadgear", "MilitaryBackpacks", "Snipers", "Explosives", "DLCRifles", "MedicalItems", "MilitaryBackpacks", "DLCGhillies", "Ghillies", "DLCGhillies", "DLCRifles", "DLCRifles", "Snipers"};
		...
		/*
			...
			Snipers           = 11,36%
		*/
		Radiation[] = {"Ghillies", "MilitaryBackpacks", "HandGrenades", "Explosives", "Snipers", "MilitaryHeadgear", "Snipers", "Restraints", "DLCRifles", "MilitaryBackpacks", "MedicalItems", "SniperAmmo", "Snipers", "MilitaryHeadgear", "DLCAmmo", "Snipers", "MilitaryBackpacks", "Explosives", "EpicWeapons", "SniperAttachments", "HandGrenades", "DLCOptics", "DLCRifles", "MedicalItems", "MilitaryHeadgear", "DLCRifles", "Explosives", "Explosives", "Snipers", "DLCGhillies", "DLCGhillies", "DLCSupressor", "DLCRifles", "Ghillies", "Ghillies", "Restraints", "MilitaryHeadgear", "DLCRifles", "EpicWeapons", "MilitaryBackpacks", "MilitaryBackpacks", "Explosives", "DLCGhillies", "MilitaryHeadgear"};
	};
	class ItemGroups
	{
	...
	class ItemGroups
	{
		...
		*/
		...
		/*
			...
			Exile_Item_InstaDoc  = 10.00%
			Exile_Item_Bandage   = 30.00%
			Exile_Item_Vishpirin = 30.00%
		*/
		MedicalItems[] = {"Exile_Item_Vishpirin", "Exile_Item_Bandage", "Exile_Item_InstaDoc"};

		/*
			Percental Item Spawn Chances of IndustrialItems:

			Exile_Item_ThermalScannerPro    = 5.00%
			Exile_Item_Knife                = 5.00%
			Exile_Item_Cement               = 50.00%
			Exile_Item_FloodLightKit        = 10.00%
			Exile_Item_PortableGeneratorKit = 10.00%
			Exile_Item_CamoTentKit          = 10.00%
			Exile_Item_MetalBoard           = 50.00%
			Exile_Item_Foolbox              = 50.00%
			Exile_Item_Sand                 = 50.00%
			Exile_Item_Grinder              = 50.00%
			Exile_Item_MetalScrews          = 50.00%
			Exile_Melee_SledgeHammer        = 50.00%
			Exile_Item_ExtensionCord        = 50.00%
			Exile_Item_WaterCanisterEmpty   = 50.00%
			Exile_Melee_Shovel              = 50.00%
			Exile_Item_JunkMetal            = 50.00%
			Exile_Item_Handsaw              = 50.00%
			Exile_Item_Pliers               = 50.00%
			Exile_Item_ScrewDriver          = 50.00%
			Exile_Melee_Axe                 = 50.00%
			Exile_Item_CodeLock             = 50.00%
		*/
		IndustrialItems[] = {"Exile_Item_ThermalScannerPro", "Exile_Item_Knife", "Exile_Item_Cement", "Exile_Item_FloodLightKit", "Exile_Item_PortableGeneratorKit", "Exile_Item_CamoTentKit", "Exile_Item_MetalBoard", "Exile_Item_Foolbox", "Exile_Item_Sand", "Exile_Item_Grinder", "Exile_Item_MetalScrews", "Exile_Melee_SledgeHammer", "Exile_Item_ExtensionCord", "Exile_Item_WaterCanisterEmpty", "Exile_Melee_Shovel", "Exile_Item_JunkMetal", "Exile_Item_Handsaw", "Exile_Item_Pliers", "Exile_Item_ScrewDriver", "Exile_Melee_Axe", "Exile_Item_CodeLock"};

		/*
			Percental Item Spawn Chances of Vehicle:

			Exile_Item_FuelCanisterFull  = 50.00%
			Exile_Item_CodeLock          = 50.00%
			Exile_Item_DuctTape          = 50.00%
		*/
		Vehicle[] = {"Exile_Item_FuelCanisterFull", "Exile_Item_CodeLock", "Exile_Item_DuctTape"};
	...
	class Respect
	{
		...
		*/
		...
		class Percentages 
		{
			...
			frag = 1; // Killing someone will get you 5% and remove 5% from the victim
		};
