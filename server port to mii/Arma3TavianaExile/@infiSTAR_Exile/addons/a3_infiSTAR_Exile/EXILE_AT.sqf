...
VERSION_DATE_IS = '10-04-2020 18-44-01';
_MAIN_CODE = {
...
fn_infiSTARAdmin_loadControls = {
	...
	_ctrl ctrlSetText format['Players loaded in: %1 of %2                 SERVER UPTIME: %3  SERVER FPS: %4  SERVER THREADS: %5          infiSTAR.de Admin Menu 10-04-2020 18-44-01 - v0094',count (call fnc_get_plr),((playersNumber west)+(playersNumber east)+(playersNumber civilian)+(playersNumber resistance)),time call FN_GET_TIME_TIME,SERVER_FPS,SERVER_THREADS];
