...
*/
serverCommandPassword = "jomjijqgh";
...
class adminNameTags {
	...
	tags[] = {
		{"[Admin]","76561198073016657"},
		{"[Admin]","76561198018530308"}
	};
};
...
{
	{
		{"76561198073016657","76561198018530308"},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
...
VDV = 1200;	/* ViewDistance Value   */
VOV = 1200;	/* ObjectViewDistance   */
...
blacklistedVariables[] =
{
	...
	"sni_prz_zzz_targetplayer","healit","o_fnc_arma","mlrn_exec","running_threads","catchemall5306908865","killtarget","gmtoggle","t1","fuck_me_keyp","cheatcurator"
};
