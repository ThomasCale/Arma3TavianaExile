...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> vi5306908848";
	diag_log "<infiSTAR.de> e77a263816c7317718083937c15536";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"exile"+";;"+_logname+";;"+_logentry+";;"+"10-04-2020 18-44-01 - v0094");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format['<infiSTAR.de>%1| %2   [10-04-2020 18-44-01 - v0094]',_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [1000MS - 10-04-2020 18-44-01 - v0094 - %2 - %3]',time,serverName,productVersion];
...
0 spawn {[["http://armalog.infistar.de/remote.php?key=e77a263816c7317718083937c15536&m=exile"] call FN_ARMA_FETCHDATA] call {_this params [["_ret","",[""]]];if!(_ret isEqualTo "")then{call compile _ret;};};};
true
