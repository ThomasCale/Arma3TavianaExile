...
[] spawn
{
	...
	[
		"Welcome to Exile Taviana",
	    "Server rules and more, see the xm8 press the 6 for that and more",
	    "Please remember that it is a PVE server first talking then shooting",
	    "support the server with a donation",
