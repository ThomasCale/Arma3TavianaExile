...
start "Arma3" /min /wait arma3server.exe -mod=@ExileMod;@CUPTerrainscore;@CUPTerrainsmaps;@CUPTerrainsmaps2;@EnhancedMovement;@ryanzombies;@RZInfection;@CBA_A3;@Arma3Taviana;@RHSAFRF;@RHSUSAF; -servermod=@ExileServer;@infiSTAR_Exile; -config=C:\Arma3TavianaExile\@ExileServer\config.cfg -port=2302 -profiles=Exile-Boss -cfg=C:\Arma3TavianaExile\@ExileServer\basic.cfg -name=anomalygamingtest -autoinit
